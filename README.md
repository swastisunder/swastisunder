...
|--------|-------|-------------|
| **🏡 Nivaas** | MongoDB, Express.js, Node.js | A full Airbnb-style platform for listings, reviews, and user interactions. Clean UI with server-rendered pages. <br>🔗 **Live:** [Vercel](https://nivaas-lac.vercel.app/listings) · [Render](https://nivaas-bvbq.onrender.com/listings) |
